...
/**
 * Genera HTML estático de Más Café desde content/site.json.
 * @param {(assetPath: string) => string} img - Resuelve rutas de imágenes
 */
export function generatePublicHtml(img) {
  ...
  const { brand, experiences, products, menu, marquee } = site;
